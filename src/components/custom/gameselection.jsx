...
const Gameselection = () => {
    ...
    return (
        <div style={{ backgroundImage: `url("/assets/game-selection-bg.png")` }} className='  bg-[#efefef] w-full h-[200px] pr-80 flex items-end flex-col justify-center max-[1390px]:pr-20 max-[1100px]:pr-5'>
