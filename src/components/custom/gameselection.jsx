...
// dir={language === 'en' ? 'rtl' : 'ltr'}
  ...
  <div 
  style={{
    backgroundImage: language !== 'en' ? `url("/assets/game-selection-bg.png")` : 'none'
                      ...
                      user.loggedIn ? (
                          <>
                              {user.game === 'blackclover' ? (
                                  <div 
                                  onClick={() => dispatch(toggleToBC())} className='flex items-center gap-2 justify-center flex-col'>
